    ...
    return (
        <div className="navbar bg-gray-700 shadow-2xl">
            <div className="navbar-start">
                ...
                <Link to={'/'} className="normal-case flex items-center text-xl md:text-2xl text-red-500 font-bold ">
                    <img className='w-6 md:w-10 h-6 md:h-10 rounded-full mr-2' src={logo} alt="" />
                Fast <span className='text-white '>Delivery</span>
                </Link>
            </div>
            ...
            <div className="navbar-end">
                {
                    user?.uid ?
                        <>
                        <img title={user?.displayName} src={user?.photoURL} className='w-10 md:w-12 h-10 md:h-12 rounded-full mr-1 md:mr-2' alt="" />
